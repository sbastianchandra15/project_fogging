<div class="row">
  <div class="col-lg-12">
    ...
    <ol class="breadcrumb">
      ...
      <li>Transaksi</li>
      <li>Input Mutasi Antar Gudang</li>
    </ol>
  </div>  
</div>
      ...
      <div class="panel-body">
        ...
        <input type="hidden" name="ni_items" id="ni_items" value='<?php echo json_encode($new_tbm["items"]); ?>' required />
          <div class="form-group">
            ...
            <div class="col-sm-3">
              <input tabindex="101" type="text" name="tanggal" id="tanggal" class="form-control" required="required" value="<?php echo isset($new_tbm['tanggal']) ? $new_tbm['tanggal']:''; ?>">
...
APL.Brg = {
    ...
    save: function(e){
      ...
      $.ajax({       
        data: { },     
        type : "POST",        
        url: APL.baseUrl+'transaksi_mutasi/save',

<div class="row">
  <div class="col-lg-12">
    ...
    <ul class="header-toolbox">
      <li class="bottom_input"><a keypress="alt b" class="btn btn-info btn-sm" href="<?php echo base_url()."transaksi_returkeluar/form" ?>"><u>B</u>aru</a></li>
    </ul>
    <ol class="breadcrumb">
      <li><a href="<?php echo base_url().'welcome'; ?>">Home</a></li>
      <li>Transaksi</li>
      <li>Retur Barang Keluar</li>
    </ol>
  </div>  
</div>
        ...
        <table id="table-barang" class="table table-hover table-bordered">
          ...
          <tr>
            ...
            <td class="action" align="center">
                      ...
                      <a Onclick="return confirmDelete()" class="hapus btn btn-danger btn-xs" href="<?php echo base_url()."transaksi_returkeluar/delete/$list->id_trans"; ?>">Hapus</a>
                    <?php } ?>
                      <a class="hapus btn btn-info btn-xs" href="<?php echo base_url()."transaksi_returkeluar/edit/$list->id_trans"; ?>">Edit</a>
                      <a target="_blank" class="hapus btn btn-info btn-xs" href="<?php echo base_url()."transaksi_returkeluar/cetak/$list->id_trans"; ?>"><span class="glyphicon glyphicon-print"></span></a>
                      <?php
                      }
                      ?>
            </td>

<div class="row">
  <div class="col-lg-12">
    ...
    <ul class="header-toolbox">
      <li class="bottom_input"><a keypress="alt b" class="btn btn-info btn-sm" href="<?php echo base_url()."transaksi_mutasi/form" ?>"><u>B</u>aru</a></li>
    </ul>
    <ol class="breadcrumb">
      <li><a href="<?php echo base_url().'welcome'; ?>">Home</a></li>
      <li>Transaksi</li>
      <li>Mutasi Antar Gudang</li>
    </ol>
  </div>  
</div>
    ...
    <section class="panel">
      <div class="table-responsive">
        <table id="table-barang" class="table table-hover table-bordered">
            ...
            $no   = 0;
            $total_saldo  = 0;
            foreach($data_transaksi_mutasi as $list):
            $no   = $no+1;
            ?>
            <tr>
              <td><?php echo $no; ?>.</td>
              ...
              <td><?php echo $list->nama_gudang_tujuan; ?></td>
              <td><?php echo $list->nama_gudang_pengambilan; ?></td>
              ...
              <td class="action" align="center">
                        ...
                        ?>
                        <a class="hapus btn btn-danger btn-xs" disabled>Batal</a>
                        ...
                        <a Onclick="return confirmDelete()" class="hapus btn btn-danger btn-xs" href="<?php echo base_url()."transaksi_mutasi/delete/$list->id_trans"; ?>">Batal</a>
                        <?php } ?>
                        <a class="hapus btn btn-info btn-xs" href="<?php echo base_url()."transaksi_mutasi/edit/$list->id_trans"; ?>">Edit</a>
                        <a target="_blank" class="hapus btn btn-info btn-xs" href="<?php echo base_url()."transaksi_mutasi/cetak/$list->id_trans"; ?>"><span class="glyphicon glyphicon-print"></span></a>
                        <?php
                        }
                        ?>
              </td>
	...
	$('#table-barang').DataTable({
      ...
      "columnDefs": [
        { // disable sorting on column process buttons
          ...
          targets: 3, width: '120px', className: 'text-left'
        },{

<div class="row">
  <div class="col-lg-12">
    ...
    <ul class="header-toolbox">
      <li class="bottom_input"><a keypress="alt b" class="btn btn-info btn-sm" href="<?php echo base_url()."transaksi_masuk/form" ?>"><u>B</u>aru</a></li>
    </ul>
    <ol class="breadcrumb">
        ...
        <table id="table-barang" class="table table-hover table-bordered">
          ...
          <tr>
            ...
            <td class="action" align="center">
                      ...
                      <a Onclick="return confirmDelete()" class="hapus btn btn-danger btn-xs" href="<?php echo base_url()."transaksi_masuk/delete/$list->id_trans"; ?>">Hapus</a>
                    <?php } ?>
                      <a class="hapus btn btn-info btn-xs" href="<?php echo base_url()."transaksi_masuk/edit/$list->id_trans"; ?>">Edit</a>
                      <a target="_blank" class="hapus btn btn-info btn-xs" href="<?php echo base_url()."transaksi_masuk/cetak/$list->id_trans"; ?>"><span class="glyphicon glyphicon-print"></span></a>
                      <?php
                      }
                      ?>
            </td>
...
function confirmDelete() {
  		return confirm("Anda yakin untuk Menghapuskan Dokumen ini ?");
	}
	...
	$('#table-barang').DataTable({
      ...
      "columnDefs": [
        { // disable sorting on column process buttons
          ...
          targets: 2, width: '70px', className: 'text-left'
        },{
          targets: 3, width: '130px', className: 'text-left'
        },{

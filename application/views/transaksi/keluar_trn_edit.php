  ...
  <div class="col-lg-12">
    <section class="panel">
      <div class="panel-body">
        ...
        <input type="hidden" name="ni_items" id="ni_items" value='<?php echo json_encode($new_tbk["items"]); ?>' required />
          <div class="form-group">
            <label class="col-sm-2 control-label">Tanggal </label>
            <div class="col-sm-3">
              <input tabindex="102" type="text" name="tanggal" id="tanggal" class="form-control" required="required" value="<?php echo isset($new_tbk['tanggal']) ? $new_tbk['tanggal']:''; ?>">
              ...
              <select tabindex="102" type="search" name="gd_pengambilan" id="gd_pengambilan" class="form-control pull-left" required="required">
                ...
                <?php
                    foreach ($data_gudang as $row) {
                      if($new_tbk['gd_pengambilan']==$row->id_gudang){
            ...
            <div class="col-sm-5">
                ...
                <?php
                     foreach ($data_toko as $row) {
                        if($new_tbk['id_toko']==$row->id_toko){
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              <textarea tabindex="103" class="form-control" rows="3" id="keterangan" name="keterangan"><?php echo isset($new_tbk['keterangan']) ? $new_tbk['keterangan']:''; ?></textarea>
              <div class="help-block with-errors"></div>
            </div>
          </div>
        <hr>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-2">
            ...
            <a keypress='alt b' tabindex="121" class="btn btn-danger" href="<?php echo base_url('transaksi_keluar/reset'); ?>" notab><u>B</u>atal</a>
          </div>
        </div>
            <?php //echo form_close(); test($new_tbk); ?>
    </div>
    </section>
  </div>
</div>
...
APL.Brg = {
    ...
    _addtogrid: function(data){
      ...
      $.post({
        url: APL.baseUrl+'transaksi_keluar/add_item',
        data: {
    ...
    _removefromgrid: function(el){
      ...
      $.get({
        url: APL.baseUrl+'transaksi_keluar/remove_item',
        data: {
          index_code: code
        }
      });
    ...
    save: function(e){
      ...
      $.ajax({       
        data: { },     
        type : "POST",        
        url: APL.baseUrl+'transaksi_keluar/edit_save',
        success : function(resp){
          ...
          if(resp.nomor_dok == 'ERROR INSERT' || resp.nomor_dok == false) {
            ...
            setTimeout(function () {
              window.location.href = APL.baseUrl+'transaksi_keluar/'; //will redirect to google.
            }, 2000);
          }
        }
      })

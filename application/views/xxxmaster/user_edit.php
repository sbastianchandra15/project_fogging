  ...
  <div class="col-lg-12">
    <section class="panel">
    	<div class="panel-body">
            <?php echo form_open(base_url()."user/edit_act",array('data-toggles'=>'validator','class'=>'form-horizontal')); ?>
                <div class="form-group">
					<label class="col-sm-2 control-label">NIP </label>
					<div class="col-sm-3">
						<input tabindex="102" type="text" name="nip" id="nip" class="form-control" required="required" value="<?php echo $data_user->nip; ?>">
						<input type="hidden" name="id" id="id" class="form-control" required="required" value="<?php echo $data_user->id; ?>">
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
						<input tabindex="102" type="text" name="nrk" id="nrk" class="form-control" required="required" value="<?php echo $data_user->nrk; ?>">
						<div class="help-block with-errors"></div>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input tabindex="102" type="text" name="nama" id="nama" class="form-control" required="required" value="<?php echo $data_user->nama; ?>">
						<div class="help-block with-errors"></div>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-6">
						<textarea tabindex="102" class="form-control" rows="3" id="jabatan" name="jabatan"><?php echo $data_user->jabatan; ?></textarea>
						<div class="help-block with-errors"></div>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-2">
						<input tabindex="104" type="checkbox" name="aktif" id="aktif" value="1" required="required" <?php echo ($data_user->aktif=='1') ? 'checked="checked"' : ''; ?>> <?php echo $data_user->aktif; ?>
						<div class="help-block with-errors"></div>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
						<input tabindex="102" type="text" name="username" id="username" class="form-control" required="required" value="<?php echo $data_user->username; ?>">
						<div class="help-block with-errors"></div>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
						<select tabindex="102" name="hak_akses" id="hak_akses" class="form-control" style="width: 75%;" required="required">
				        	...
				        	<option value="1" <?php echo ($data_user->hak_akses==1) ? 'selected="selected"' : ''; ?> >Super Admin</option>
				        	<option value="2" <?php echo ($data_user->hak_akses==2) ? 'selected="selected"' : ''; ?>>Admin Gudang</option>
				        	</select>
						<div class="help-block with-errors"><span id='message'></span></div>
					</div>
				</div>

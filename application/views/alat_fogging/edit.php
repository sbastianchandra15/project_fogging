<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Edit Alat Fogging</h1>
    </div>
</div>
<div class="row">
    <div class="col-lg-12">
                        ...
                        <form role="form">
                        	<div class="row">
	                            <div class="form-group">
	                                ...
	                                <div class="col-lg-5">
		                                ...
		                                <input class="form-control" type="hidden" id="id_alat" value="<?php echo $detail->id_alat; ?>">
	                                </div>
	                                <div class="col-lg-3">
	                            ...
	                            <div class="form-group">
	                                ...
	                                <div class="col-lg-5">
		                                <select class="form-control" id="id_kat">
		                                	...
		                                	if($value->id_kat==$detail->id_kat){
		                                	?>
		                                		<option value="<?php echo $value->id_kat; ?>" selected><?php echo $value->kategori; ?></option>
		                                	<?php
		                                	}else{
		                                	?>
	                        ...
	                        <div class="row">
	                            <div class="form-group">
	                                ...
	                                <div class="col-lg-5">
		                                <input class="form-control" type="text" id="no_seri" value="<?php echo $detail->no_seri; ?>">
	                                </div>
	                                <div class="col-lg-3">
	                        ...
	                        <div class="row">
	                            <div class="form-group">
	                                ...
	                                <div class="col-lg-5">
		                                <input class="form-control" type="date" id="tgl_beli" value="<?php echo $detail->tgl_beli; ?>">
	                                </div>
	                                <div class="col-lg-3">
...
<script type="text/javascript">
	...
	$('#simpan').click(function(){
		...
		$.ajax({
			url			: baseUrl+'alat_fogging/edit_act',
			type 		: 'POST',
			data 		: {
				nama 		: $('#nama').val(),
				id_kat 		: $('#id_kat').val(),

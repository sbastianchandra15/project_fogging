                        ...
                        <form role="form">
                        	<div class="row">
	                            <div class="form-group">
	                                ...
	                                <div class="col-lg-5">
		                                <input class="form-control" type="text" id="kategori" value="<?php echo $detail->kategori ?>">
		                                <input class="form-control" type="hidden" id="id_kat" value="<?php echo $detail->id_kat ?>">
	                                </div>
	                                <div class="col-lg-3">

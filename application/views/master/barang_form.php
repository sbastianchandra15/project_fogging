<div class="row">
  <div class="col-lg-12">
    <h3 class="page-header">Input Barang</h3>
  ...
  <div class="col-lg-12">
    <section class="panel">
    	<div class="panel-body">
            <?php echo form_open(base_url()."barang/form_act",array('id'=>'frmBKB','data-toggles'=>'validator','class'=>'form-horizontal')); ?>
                <div class="form-group">
					<label class="col-sm-2 control-label">Kode barang </label>
					<div class="col-sm-3">
						<input tabindex="102" type="text" name="kd_barang" id="kd_barang" class="form-control" required="required">
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input tabindex="102" type="text" name="nama_barang" id="nama_barang" class="form-control" required="required">
						<div class="help-block with-errors"></div>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-2">
						<input tabindex="102" type="checkbox" name="aktif" id="aktif" value="1" required="required">
						<div class="help-block with-errors"></div>
					</div>
				</div>
				</br>

<div class="row">
  <div class="col-lg-12">
    <h3 class="page-header">Master Toko</h3>
    <ul class="header-toolbox">
      <li class="bottom_input"><a keypress="alt b" class="btn btn-info btn-sm" href="<?php echo base_url()."toko/form" ?>"><u>B</u>aru</a></li>
    </ul>
    <ol class="breadcrumb">
  ...
  <div class="col-lg-12">
    <section class="panel">
      <div class="table-responsive">
        ...
        $no   = 0;
        $total_saldo  = 0;
        foreach($data_toko as $list):
        $no   = $no+1;
        ?>
        <tr>
          <td><?php echo $no; ?>.</td>
          <td><?php echo $list->kode_toko; ?></td>
          ...
          <td class="action">
                    ...
                    <!--<a Onclick="return confirmDelete()" class="hapus btn btn-danger btn-xs" href="<?php //echo base_url()."toko/delete/$list->id_toko"; ?>">Hapus</a>-->
                    <a class="hapus btn btn-info btn-xs" href="<?php echo base_url()."toko/edit/$list->id_toko"; ?>">Edit</a>
                    <?php if($this->session->userdata('hak_akses')=='1'){ ?>
					 <a class="hapus btn btn-info btn-xs" href="<?php echo base_url()."toko/delete/$list->id_toko"; ?>">Hapus</a>
          <?php } ?>
          </td>
        </tr>
        <?php endforeach; ?>

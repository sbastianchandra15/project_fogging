<div class="row">
  <div class="col-lg-12">
    <h3 class="page-header">Master Gudang</h3>
    <ul class="header-toolbox">
      <li class="bottom_input"><a keypress="alt b" class="btn btn-info btn-sm" href="<?php echo base_url()."gudang/form" ?>"><u>B</u>aru</a></li>
    </ul>
    <ol class="breadcrumb">
      ...
      <div class="table-responsive">
        <table id="table-barang" class="table table-hover table-bordered">
			...
			<tr>
				...
				<td class="action">
                <!--<a Onclick="return confirmDelete()" class="hapus btn btn-danger btn-xs" href="<?php //echo base_url()."gudang/delete/$list->id_gudang"; ?>">Hapus</a>-->
                <a class="hapus btn btn-info btn-xs" href="<?php echo base_url()."gudang/edit/$list->id_gudang"; ?>">Edit</a>
	...
	$('#table-barang').DataTable({
      ...
      "columnDefs": [
        { // disable sorting on column process buttons
          ...
          targets: 3, width: '135px', className: 'text-left'
        },{

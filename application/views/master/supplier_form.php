<div class="row">
  <div class="col-lg-12">
    <h3 class="page-header">Input Supplier</h3>
  ...
  <div class="col-lg-12">
    <section class="panel">
    	<div class="panel-body">
            <?php echo form_open(base_url()."supplier/form_act",array('data-toggles'=>'validator','class'=>'form-horizontal')); ?>
                <div class="form-group">
					<label class="col-sm-2 control-label">Kode Supplier </label>
					<div class="col-sm-3">
						<input tabindex="102" type="text" name="kd_supplier" id="kd_supplier" class="form-control" required="required">
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input tabindex="102" type="text" name="nama_supplier" id="nama_supplier" class="form-control" required="required">
						<div class="help-block with-errors"></div>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-6">
						<textarea tabindex="103" class="form-control" rows="3" id="alamat" name="alamat"></textarea>
						<div class="help-block with-errors"></div>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input tabindex="102" type="text" name="telp" id="telp" class="form-control" required="required">
						<div class="help-block with-errors"></div>
					</div>
				</div>
				</br>

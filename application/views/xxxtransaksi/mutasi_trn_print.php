<section>
  <h4 class="text-center">TRANSAKSI MUTASI ANTAR GUDANG</h4>
  <table>
    <tr align="left" class="h5">
      <td width=40%></td>
      <td width=13%>Nomor </td>
      <td width=1%>:</td>
      <td width=19%><?php echo $data_header->kd_trans; ?></td>
    </tr>
    <tr align="left" class="h5">
      <td></td>
      <td>Tanggal </td>
    ...
    <tr align="left" class="h5">
      <td></td>
      <td>Gd Pengambilan </td>
      <td>:</td>
      <td><?php echo $data_header->nama_gudang_pengambilan;  ?></td>
    </tr>
    <tr align="left" class="h5">
      <td></td>
      <td>Gd Tujuan </td>
      <td>:</td>
      <td><?php echo $data_header->gudang_tujuan;  ?></td>
    </tr>
    <tr align="left" class="h5">
      <td></td>
      <td>Keterangan </td>

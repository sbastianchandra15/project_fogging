      ...
      <div class="panel-body">
        ...
        <input type="hidden" name="ni_items" id="ni_items" value='<?php echo json_encode($new_tbk["items"]); ?>' required />
          <div class="form-group">
            ...
            <div class="col-sm-3">
              <input tabindex="101" type="text" name="tanggal" id="tanggal" class="form-control" required="required" value="<?php echo isset($new_tbk['tanggal']) ? $new_tbk['tanggal']:''; ?>">
...
APL.Brg = {
    ...
    save: function(e){
      ...
      $.ajax({       
        data: { },     
        type : "POST",        
        url: APL.baseUrl+'transaksi_keluar/save',
        success : function(resp){
          ...
          if(resp.nomor_dok == 'ERROR INSERT' || resp.nomor_dok == false) {
            ...
            return false;
          }else if(resp.nomor_dok == 'STOK' || resp.nomor_dok == false) {
            $.notify({
              icon: "img/growl_64x.png",
              message: "Data Gagal disimpan, Karena STOK Tidak Cukup."
            },{
              type: 'danger'
            });
            setTimeout(function () {

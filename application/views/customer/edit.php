                        ...
                        <form role="form">
                        	<div class="row">
                        		<div class="form-group">
	                                ...
	                                <div class="col-lg-5">
		                                <input class="form-control" type="text" id="no_ktp" value="<?php echo $detail->no_ktp; ?>">
		                                <input class="form-control" type="hidden" id="no_ktp_old" value="<?php echo $detail->no_ktp; ?>">
	                                </div>
	                                <div class="col-lg-3">
	                        ...
	                        <div class="row">
	                            <div class="form-group">
	                                ...
	                                <div class="col-lg-5">
		                                <input class="form-control" type="text" id="nama" value="<?php echo $detail->nama; ?>">
	                                </div>
	                                <div class="col-lg-3">
	                        ...
	                        <div class="row">
	                            <div class="form-group">
	                                ...
	                                <div class="col-lg-5">
		                                <input class="form-control" type="text" id="alamat" value="<?php echo $detail->alamat; ?>">
	                                </div>
	                                <div class="col-lg-3">
	                        ...
	                        <div class="row">
	                            <div class="form-group">
	                                ...
	                                <div class="col-lg-5">
		                                <input class="form-control" type="text" id="telp" value="<?php echo $detail->telp; ?>">
	                                </div>
	                                <div class="col-lg-3">
	                        ...
	                        <div class="row">
	                            <div class="form-group">
	                                ...
	                                <div class="col-lg-5">
		                                <input class="form-control" type="date" id="tgl_lahir" value="<?php echo $detail->tgl_lahir; ?>">
	                                </div>
	                                <div class="col-lg-3">
	                        ...
	                        <!-- <div class="row">
	                            <div class="form-group">
	                                ...
	                                <div class="col-lg-5">
		                                <input class="form-control" type="date" id="tgl_register" value="<?php echo $detail->tgl_register; ?>">
	                                </div>
	                                <div class="col-lg-3">
	                        ...
	                        <div class="row">
	                            <div class="form-group">
	                                ...
	                                <div class="col-lg-5">
		                                <input class="form-control" type="email" id="email" value="<?php echo $detail->email; ?>">
	                                </div>
	                                <div class="col-lg-3">
	                        ...
	                        <div class="row">
	                            <div class="form-group">
	                                ...
	                                <div class="col-lg-5">
		                                <input class="form-control" type="text" id="username" value="<?php echo $detail->username; ?>">
	                                </div>
	                                <div class="col-lg-3">
